...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "86", version = "",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-86/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getTest() {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity("20011").build();
    }
    return null;
  }
